...
public class OutstationBookFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.activity_outstation_book, container, false);
        strBookFor = "";
        strTrip = "";
        strAC = "";
        strPickup = "";
        ...
        Thread t = new Thread() {
            ...
            public void run() {
                ...
                /*Checking response */
                    ...
                    e.printStackTrace();
                    alertDialog("Error: Cannot Establish Connection", getContext());
                }
